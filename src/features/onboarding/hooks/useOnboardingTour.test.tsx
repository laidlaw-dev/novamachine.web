...
describe("useOnboardingTourStore", () => {
  describe("registerPage", () => {
    test("when hasVisitedPage returns true, does nothing", () => {
      mock_hasVisitedPage.mockReturnValue(true)
      ...
      act(() => {
        result.current.registerPage("test_page")
      })

      expect(result.current.currentStep).toBeNull()
    })
    test("when hasVisitedPage returns false, starts tour and marks page as visited", () => {
      mock_hasVisitedPage.mockReturnValue(false)
      ...
      expect(mock_setVisitedPage).toHaveBeenCalledWith("test_page")
    })
  })
  describe("startTour", () => {
